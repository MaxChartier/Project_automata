...
def save_automaton_info(number, alphabet, number_states, initial_states, final_states, transitions):
    directory = "infos automata"
    file_path = os.path.join(directory, number+".txt")
    print(file_path)
    try:
...
number_a = input("What is the automata number you want to observe?\n(Following the form 0n)\n")
...
save_automaton_info(number_a, alphabet, number_states, initial_state, final_states, transitions)
if is_standard != True:
